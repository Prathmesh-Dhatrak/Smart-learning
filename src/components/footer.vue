      ...
      <div class="row">
        ...
        <div class="col-xs-6 col-md-3">
          ...
          <ul class="footer-links">
            <li>
              <router-link to="/alphabets">Alphabets</router-link>
            </li>
            <li>
      ...
      <div class="row">
        <div class="col-md-8 col-sm-6 col-xs-12">
          <p class="copyright-text">
            ...
            <a href="https://github.com/Prathmesh9860">HellionCoders</a>.
          </p>
        </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <ul class="social-icons">
            <li>
              <a class="facebook" href="https://github.com/Prathmesh9860"
                ><i class="fa fa-facebook"></i
              ></a>
            </li>
            <li>
              <a class="twitter" href="https://www.instagram.com/hellioncoder/"
                ><i class="fa fa-twitter"></i
              ></a>
            </li>
            <li>
              <a class="linkedin" href="linkedin.com/in/prathmeshsd"
                ><i class="fa fa-linkedine"></i
              ></a>
            </li>
          </ul>
        </div>
